...
import { ArrowLeft, Lock, Mail, Shield, RefreshCw } from "lucide-react";
          ...
          {step === "sent" && (
            <div className="rounded-2xl border border-[#E5E5E2] bg-white p-8 shadow-sm text-center">
              ...
              <button
                ...
                className="mt-5 flex w-full items-center justify-center gap-2 text-[13px] text-[#6B7280] hover:text-[#111827] transition-colors py-2"
              >
